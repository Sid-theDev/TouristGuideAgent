...
def ([task_name][self, agent, [parameters]]):
    ...
    **Task**: [Provide a concise task name or summary of the task.]
    **Description**: [Detailed description of what the agent is expected to do, including actionable steps and explainations]
...
**Note**: [Optional selection for incentives or encouragement for high-quality work. This include tips, ]
